    ...
    return (
        <footer className="bg-muted py-16">
            <div className="mx-auto max-w-5xl px-6">
                ...
                {/* Esta seccion se puede descomentar si se desea mostrar los links a secciones
                ...
                <span className="text-muted-foreground block text-center text-sm"> © {new Date().getFullYear()} Soluciones Ambientecnica S.A.C. | FV COOLSYSTEMS - Todos los derechos reservados</span>
            </div>
        </footer>
    )
}
